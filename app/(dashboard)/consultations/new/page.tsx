...
export const metadata: Metadata = { title: "Record consultation" };

export default async function NewConsultationPage({
  searchParams,
}: PageProps<"/consultations/new">) {
  const ctx = await loadContext("consultation.create");
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-6 py-8">
      ...
      <ConsultationForm defaults={{ patientId: patient.id, appointmentId }} />
    </div>
  );
}
